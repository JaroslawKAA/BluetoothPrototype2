...
public class BluetoothLEHardwareInterface
{
	...
	public static BluetoothDeviceScript Initialize (BluetoothDeviceRole bluetoothDeviceRole, Action action, Action<string> errorAction)
	{
	...
	public static void ConnectToPeripheral (string macAddress, Action<string> onConnected, Action<string, string> onServiceEnumeration, Action<string, string, string> onCharacteristicEnumeration, Action<string> onDisconnected = null)
	{
#if !UNITY_EDITOR_OSX || !EXPERIMENTAL_MACOS_EDITOR
        if (!Application.isEditor)
		{
