...
public class ArduinoHM10Test : MonoBehaviour
{
            ...
            if (_timeout <= 0f)
            {
                ...
                switch (_state)
                {
                    ...
                    case States.Connect:
                        ...
                        BluetoothLEHardwareInterface.ConnectToPeripheral(_hm10, null, null,
                    ...
                    case States.Subscribe:
                        ...
                        BluetoothLEHardwareInterface.SubscribeCharacteristicWithDeviceAddress(_hm10, ServiceUUID,
                            Characteristic, null,
                    ...
                    case States.Unsubscribe:
                        BluetoothLEHardwareInterface.UnSubscribeCharacteristic(_hm10, ServiceUUID, Characteristic,
                            null);
    ...
    void SendString(string value)
    {
        ...
        // the device
        BluetoothLEHardwareInterface.WriteCharacteristic(_hm10, ServiceUUID, Characteristic, data, data.Length, false,
